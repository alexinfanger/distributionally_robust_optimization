...
\begin{theorem} \emph{(Strong Duality for DRO)} Under the assumptions (A1) and (A2), we have that the primal problem
\begin{align*}
\begin{array}{ll@{}ll}
...
\end{array}
\end{align*}
is equal to the dual problem, (which upon noting the form of the optimizer can be written as a one dimensional problem)
\begin{align*}
\begin{array}{ll@{}ll}
